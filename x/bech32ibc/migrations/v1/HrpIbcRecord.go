...
// This file is a copy of the generated types.pb.go file from the v1 version of the bech32ibc module.
// It is not meant to be used for anything besides the migration from v1 to v2.
