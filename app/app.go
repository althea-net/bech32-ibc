...
func (app *App) GetKey(storeKey string) *sdkstore.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *App) GetTKey(storeKey string) *sdkstore.TransientStoreKey {
...
func (app *App) GetMemKey(storeKey string) *sdkstore.MemoryStoreKey {
